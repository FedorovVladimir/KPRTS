Feature: Работа с второй тройкой (парой) кнопок нижней панели
  ...
  Scenario: Работа с первой тройкой (парой) кнопок 15
    When Я повернул рычаг в положение "2"
    When Я нажал кнопку "PA"
    When Я нажал кнопку "MB2"
    Then На панели "4" текст " 118,000"
  ...
  Scenario: Работа с первой тройкой (парой) кнопок 16
    When Я повернул рычаг в положение "2"
    When Я нажал кнопку "PA"
    When Я нажал кнопку "MB2"
    When Я нажал кнопку "MB1"
  ...
  Scenario: Работа с первой тройкой (парой) кнопок 17
    When Я повернул рычаг в положение "2"
    When Я нажал кнопку "MB3"
    When Я нажал кнопку "RD"
    Then На панели "4" текст " 118,000"
    Then На панели "5" текст " 118,000"
    Then На панели "6" текст "ПШ      "
    Then Не горит "MB1"
